<template>
  <div>
    ...
    <el-button @click="addQuestion" type="primary" plain></el-button>
    <div
      v-for="question in questions"
      :key="question.qid"
      style="cursor:pointer;"
      @click="getQuestion(question.qid)"
    >
...
<script>
import { _signup, _getQuestions, _addQuestion, _addAttitude } from "../js/api";
export default {
  created() {
    this.getQuestions();
  },
